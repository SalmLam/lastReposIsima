...
insert into nutrition_info(id, classe, lower_bound, upper_bound, color) values(1, 'Trop Bon', -10000, -1, 'green');
insert into nutrition_info(id, classe, lower_bound, upper_bound, color) values(2, 'Bon', 0, 2, 'light green');
insert into nutrition_info(id, classe, lower_bound, upper_bound, color) values(3, 'Mangeable', 3, 10, 'yellow');
insert into nutrition_info(id, classe, lower_bound, upper_bound, color) values(4, 'Mouai', 11, 18, 'orange');
insert into nutrition_info(id, classe, lower_bound, upper_bound, color) values(5, 'Degueu', 19, 40, 'red');


insert into product(id,bar_code, name, nutrition_score, color, classe) values(75,'code1', 'name1', 9, 'color1', 'classe1');
